...
def cornersHeuristic(state, problem):
  ...
  # Use the maximum Manhattan distance to any unvisited corner
...
def foodHeuristic(state, problem):
  ...
  foodList = foodGrid.asList()  # get coordinates of all remaining food
  if not foodList:
    return 0

  # Compute the maze distance (shortest path considering walls)
  # to each food and take the farthest one
  distances = []
  for food in foodList:
      # Use Manhattan distance instead of mazeDistance for speed (tricky search was freezing nikitumia mazeDistance)
